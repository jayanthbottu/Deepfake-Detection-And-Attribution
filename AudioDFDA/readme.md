# 🎧 Audio DeepFake Detection and Attribution (Audio-DFDA)
...
3. **CNN Classification**
   ...
   - Extracts frequency–time features distinctive of synthetic speech.
4. **Attribution**
...
├── AudioOut.txt                    # Training logs and metrics
│
├── saved_models/                   # Trained model checkpoints
│   └── best_model_*.pt
│
├── training_reports/               # Plots & metrics
│   └── YYYYMMDD_HHMMSS/
│       ├── metrics/
│       └── plots/
│
├── data/
│   └── audio_dfda/                 # Downloaded dataset folders
│       ├── ElevenLabs/
│       ├── Tacotron/
│       ├── TextToSpeech/
│       ├── VoiceConversion/
...
* 🎵 **Automatic DeepFake Audio Detection**
* 🧠 **Attribution across multiple generation techniques**
* 📊 **Comprehensive training analytics (F1, Precision, Recall)**
* 🖥️ **Streamlit dashboard for real-time inference**
* ⚙️ **GPU-optimized training pipeline**
...
2. **Setup Authentication**
   ...
   * Go to your Kaggle account → Create New API Token.
...
Ensure Python ≥ 3.10 and CUDA 11.8 (for GPU users).
...
├── Conv2D(128, 3x3) + BN + ReLU + Dropout(0.3)
├── Flatten
...
## 🌐 Using Streamlit for Audio DFDA
...
│   └── best_model_20251008_194321.pt
│
├── training_reports/                # Metrics and plots
│   └── 20251008_194321/
│       ├── metrics/
